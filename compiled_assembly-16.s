...
float_var_14: .double 3.5
float_var_15: .double 2.2
float_var_16: .double 8.1
...
main:
	# Evaluating: 3.5 - 2.2 + 8.1

	sub $8, %rsp			# Push float (as double) to stack
	movsd float_var_14(%rip), %xmm0
	movsd %xmm0, (%rsp)

	sub $8, %rsp			# Push float (as double) to stack
	movsd float_var_15(%rip), %xmm0
	movsd %xmm0, (%rsp)
